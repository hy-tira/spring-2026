...
Linked lists give thus efficient way to implement <i>stack</i> and <i>queue</i>, the former supporting append() and pop(), and the latter supporting append(), pop(0). With such implementation, both support accessing the first and last elements.
