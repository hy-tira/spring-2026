...
Linked lists give thus efficient way to implement <i>stack<i> and <i>queue</i>, the former supporting append() and pop() and the latter supporting append() and pop(0).
